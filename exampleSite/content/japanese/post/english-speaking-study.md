...
個人的に、「公園の井戸端会議程度の表面的な会話ができればオッケー」とかでなければ、<span class="keiko-red">**オンライン英会話ではぶっちゃけあんまり練習にならない**</span>と思います。

日本にいた時、志望していたアメリカ大学院の教授が「面談してくれる」というので、質問メモを用意し、事前練習のために何度かDMM英会話を使用しましたが、レッスン開始後5分程度で「あなたは大丈夫ですよ」と言われ、全く会話になりませんでした。

オンライン英会話の講師は資格なしで、ルーティーン化した会話（自己紹介や今日の出来事など）に対応できればなれます。

日本語に変換して考えるとわかりますが、これってぶっちゃけ中学生レベルです。

<span class="keiko-red">**オンライン英会話では「思考レベル中学生ぐらいの会話」以上は学習できません。**</span>-->
